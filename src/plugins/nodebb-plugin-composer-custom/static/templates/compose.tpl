		...
		<div class="category-tag-row">
			<div class="btn-toolbar formatting-bar">
				...
				<div class="btn-group pull-right action-bar">
					...
					<button type="submit" form="compose-form" class="btn btn-danger composer-submit" data-action="post" tabindex="6" data-text-variant=" [[topic:composer.schedule]]"><i class="fa fa-check"></i> [[topic:composer.submit]]</button>
				</div>
			</div>
		</div>
